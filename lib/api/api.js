...
import { similarityRouter } from './routes/similarityRouter.js';
...
service.use('/api/similarity', similarityRouter);
service.use('/api/dashboard', dashboardRouter);
service.use('/api/media', mediaRouter);
